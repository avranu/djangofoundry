...
class ChatGPTBugFixer:
        ...
        try:
            response = openai.ChatCompletion.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "Your job is to identify bugs in python code and suggest improvements, adhering to modern best "
    ...
    def process_python_files(self):
        ...
        for file_path in tqdm(python_files, desc="Processing files", unit="file"):
            ...
            try:
                with open(file_path, encoding="utf-8") as source_code:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--max", "-m", default=0, type=int, help="Maximum number of files to process (default: 0, i.e. no limit)"
    )
