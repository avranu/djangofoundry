...
class Db:
    ...
    def __init__(
        self, data_path: str | pathlib.Path = DEFAULT_DATA_PATH, log_path: str | pathlib.Path = DEFAULT_LOG_PATH
    ):
        """
...
def main() -> None:
    ...
    parser.add_argument(
        "-a", "--app", type=str, metavar="app", default="djangofoundry", help="Name of the application."
    )
    parser.add_argument(
