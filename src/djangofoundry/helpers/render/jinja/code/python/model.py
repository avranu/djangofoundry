...
class ModelHelper(PythonHelper):
    ...
    def __init__(
        ...
        app_name: str = "lib",
        template_path: str = "templates/jinja",
        autoescape: list = list,
        template_suffix: str = ".py.jinja",
    ):
        """
    ...
    def suggest_model_name(self, table_name: str | None = None) -> str:
        """
    ...
    def humanize_table_name(self, table_name: str | None = None) -> str:
        """
    ...
    def get_columns(self, table_name: str | None = None) -> list[ColumnInfo]:
        """
    ...
    def get_constraints(self, table_name: str | None = None) -> list[ConstraintInfo]:
        """
    ...
    def render(self, variables: dict, template_name: str = "model") -> str | None:
        ...
        try:
            ...
            logger.error(f"Template '{template_name}' not found: {e!s}")
            return None
        except Exception as e:
            logger.error(f"Error generating code from template '{template_name}': {e!s}")
            return None
