...
default_settings = {"show_eta": True}
...
class ProgressBar(ProgressRecorder):
    ...
    def __init__(self, task: Task | None = None, total: int = 1, settings: dict | None = None):
        """
    ...
    def restart(self, total: int = 100, description: str | None = None):
        """
    ...
    def next(self, description: str | None = None, advance: int = 1) -> int:
        """
    ...
    def advance(self, amount: int, description: str | None = None) -> int:
        """
    ...
    def update(self, current: int | None = None, description: str | None = None, total: int | None = None):
        """
    ...
    def refresh_task_state(self) -> None:
        ...
        self.task.update_state(state=self.state, meta=self.meta)
