...
class Hooks:
    ...
    @classmethod
    def get(cls, name: str | None = None, namespace: str = DEFAULT_NAMESPACE) -> list[Hook]:
        """
    ...
    @classmethod
    def get_waypoints(cls, name: str | None = None, namespace: str = DEFAULT_NAMESPACE) -> Iterable[Waypoint]:
        """
    ...
    @classmethod
    def count(cls, name: str | None = None, namespace: str = DEFAULT_NAMESPACE) -> int:
        """
    ...
    def register_waypoint(
        ...
        named_arguments: list[str] | None = None,
        return_type: Any = Any,
    ...
    @classmethod
    def _initialize_waypoint(
        cls, name: str | None = None, namespace: str | None = None, waypoint: Waypoint = None
    ) -> Waypoint:
        """
